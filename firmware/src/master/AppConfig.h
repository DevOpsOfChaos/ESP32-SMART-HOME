...
// Standardintervall für periodische TIME-Verteilung (Sekunden).
// Begründung: 60 s reichen für lokale Node-Zeitstempel.
constexpr unsigned long TIME_SYNC_INTERVAL_S = 60UL;
