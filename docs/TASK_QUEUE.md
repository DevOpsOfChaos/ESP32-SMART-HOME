...
## Prioritaet jetzt
1. Fuer `net_sen` als naechstes den realen DHT22-Hardwarepfad auf `net_sen_01` pruefen und VCC/GND/DATA/Pull-up bzw. den DHT22 selbst klaeren; erst nach plausiblen Realwerten den offiziellen Servernachweis ansetzen
